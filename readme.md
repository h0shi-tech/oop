...
- Для задачи-проекта № 9 автомат ставится за полностью выполненный проект
  ...
  Максимальная оценка, помимо успешности защиты, определяется сданными лабораторными работами:
  - Для "отлично" должны быть сданы 5 лабораторных работ (каждая - на 3 базовых балла из 3).
  - Для "хорошо" должны быть сданы 5 лабораторных работ (каждая - как минимум на 2 базовых балла из 3).
  - Для "удовлетворительно" должны быть сданы 4 лабораторные работы
    (каждая - как минимум на 1 базовый балл из 3;
    при этом в совокупности должно быть не менее 6 базовых баллов из 12 за первые 4 работы).
